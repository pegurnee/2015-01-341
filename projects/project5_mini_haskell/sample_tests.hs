...
testGather1 = (gather [(0,[True,True]),(1,[True,False]),(2,[False,True])]) == (3,[True,True,True,False,False,True])
testGather2 = (gather [(0,[1,4,7]),(1,[2,5]),(2,[3,6])]) == (3,[1,4,7,2,5,3,6])
